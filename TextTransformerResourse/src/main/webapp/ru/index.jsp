...
<body>
	<center>
		...
		<header>
			<div class="c">
				...
				<div class="dropdown">
					<button class="styled-button2 id="menu">МЕНЮ</button>
					<div class="dropdown-content">
						<a class="styled-button"
							...
							class="styled-button" href="address/LowerCaseTransformer.jsp"
							id="LowerCaseTransformer">ToLowerCaseTransformer</a> <a
							class="styled-button" href="address/LineBreaksRemover.jsp"
							id="LineBreaksRemover">LineBreaksRemover</a>
					</div>
				</div>
				...
				<button class="styled-button" style="float: right;" ; button
					onclick="window.location.href = 'http://localhost:8080/index.jsp';"
					id="index">ENG</button>
				</a>
		</header>
	</center>
	...
	<div class="text-box">
		...
		<h3>Cайт TextTransformer в процессе разработки</h3>
		<p>byOlegov
	</div>
	...
	<div class="container">
		<div class="text-box2" style="font-size: 18px;">
			The project 
			    ...
			    <a class="button-link"
				href="http://localhost:8080/ru" id="index">TextTransformer</a>
				 
				
				is first project and we kindly ask you to take any meet mistakes
			and bugs with understanding, as the team is only looking for some
			expirience and provide this resource only basing on personal needs
			and ready to solve any problems by request.
		</div>
		...
		<div class="text-box2"
			...
			here, kindly <a
				href="mailto:oi243012@gmail.com?subject=Letter topic&body=Text of the letter"
				class="email-button"> <b>write us on email</b></a>
	...
	<div class="wrapper">
		<div class="text-box3" style="width: 67%; height: 500px; order: 2;">
			...
			<p>
				...
				id="LineBreaksRemover">LineBreaksRemover
				</a> - this function allow you to copy and paste your text from any
				previously formatted image and get it without any unneeded line
				breaks
			<p>
				<a class="button-link"
					href="address/CapitalFirstLetterTransformer.jsp"
					id="LineBreaksRemover">CapitalFirstLetterTransformer
					</a> - you can place your text and get it with first letters of each
				sentence converted into capital
		</div>
		<div class="text-box3" style="width: 32.5%; height: 205px; order: 1;">
			...
			and paste transformed result in any text editor or service you want</div>
		<div class="text-box3"
			style="width: 32.5%; height: 290px; order: 3; transform: translateY(-297px);">
			Third text</div>
	</div>
	<div class="footer">All rights reserved @byOlegov</div>
</body>
