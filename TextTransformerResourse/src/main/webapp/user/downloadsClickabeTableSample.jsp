...
<div class="text-box"
	style="height: 70vh; text-align: left; padding-left: 20px;">
...
<table class="sortable-table">
 ...
 <!--  <tbody>
    <tr>
      ...
      <td>Киев</td>
      <td></td>
      <td><a class="styled-button" href="http://localhost:8080//user/users/user21/2026-May-30 22-12 toUpperCase" download><img src="/images/1904659-arrow-backup-down-download-save-storage-transfer_122509.png"style="max-width: 21.5px; height: auto;"></a></td>
    </tr>
    <tr>
      <td>2026-May-31</td>
      <td>34</td>
