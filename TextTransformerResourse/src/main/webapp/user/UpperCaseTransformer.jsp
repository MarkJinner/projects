...
<body>
	<center>
		...
		<header>
			<div class="c">
				<a class="styled-button" href="http://localhost:8080/user/index.jsp"
					id="index">MAIN</a>
				<div class="dropdown">
	...
	<div class="translationForm" style = "height: 55%; padding:50px;">
			...
			<form id="myForm" method="post">
				...
				<center>
					<input type="submit" id="openModalBtn" class="styled-button2"
						...
						<input type = "button" id="saveButton" class="styled-button2" style="margin: 3px;"value="Save as .txt">
			</form>
	...
	<div class="text-box" style= "height: 30vh; position: relative;">
...
ignoreButton.addEventListener('click', function(event) {
    event.stopPropagation(); // Игнорирование одной из кнопок в форме - важно, чтобы кнопка была input type = "button", иначе не будет игнорировать
    // Можно добавить 
