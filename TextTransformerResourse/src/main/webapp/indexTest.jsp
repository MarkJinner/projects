...
<div id="chat-widget" class="chat-widget hidden">
    ...
    <div class="chat-body" id="chat-body">
        <div class="bot-message">Привет! Чем я могу помочь?</div>
    </div>
	...
	<div class="container">
		<div class="text-box2"
			style="font-size: 18px; width: 35%; position: relative;">
		...
		<div class="text-box2"
			style="margin-left: 7px; font-size: 18px; width: 65%; position: relative;">
...
async function sendMessage() {
    ...
    // Здесь может быть вызов анимации печати (например, "Печатает...")

    try {
        // Укажите URL вашего сервера или API-роута
        ...
        appendMessage(data.reply, 'bot'); // Предполагается, что сервер возвращает { reply: "Ответ" }

    } catch (error) {
        console.error('Ошибка:', error);
        appendMessage('Извините, произошла ошибка.', 'bot');
    }
}

// Отправка по клику и Enter
